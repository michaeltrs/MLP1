...
num_labels = 7
num_epochs = 200
num_epochs_no_improve = 30

datadir = ("/data/mat10/CO395/CW2/datasets/FER2013")
savedir = ("/data/mat10/CO395/CW2/resnet101_logs")
...
resout, end_points = resnet_v2.resnet_v2_101(xbatch, num_classes=num_labels)
...
xtrain, ytrain, xtest, ytest = get_FER2013_data(datadir, labels, mirror=True)
...
for epoch in range(num_epochs):
    ...
    if test_accuracy > best_test_accuracy:
        ...
        print("best model saved, test accuracy is %.4f" % best_test_accuracy)
...
np.savetxt(savedir + "/test_accuracy_history.csv", np.array(test_accuracy_hist))
