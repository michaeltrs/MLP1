...
num_labels = 7
num_epochs = 200
num_epochs_no_improve = 50

datadir = ("/data/mat10/CO395/CW2/datasets/FER2013")
savedir = ("/data/mat10/CO395/CW2/conv01_logs")
model_name = "/conv01"
# USER INPUT - END ---------------------------------------------------- #
...
# Output Tensor Shape: [batch_size, 7 * 7 * 64]
pool2_flat = tf.reshape(pool2, [-1, 12 * 12 * 32])
print("shape of pool2_flat is %s" % pool2_flat.get_shape)
dropout = tf.layers.dropout(
  inputs=pool2_flat, rate=0.4)
...
xtrain, ytrain, xtest, ytest = get_FER2013_data(datadir, labels, validation_ratio=0.05, mirror=True)
